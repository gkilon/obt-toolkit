...
const ImmunityMap: React.FC = () => {
  ...
  const handleResetSingleInsight = (columnId: ColumnId) => {
    setInsightsData(prev => {
        const newInsights = { ...prev };
        delete newInsights[columnId];
        return newInsights;
    });
  };
  ...
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 items-start pt-6">
        {columnsConfig.map(col => {
          ...
          return (
            <Column
              ...
              onResetInsight={() => handleResetSingleInsight(col.id)}
